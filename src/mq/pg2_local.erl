...
init([]) ->
    pg2_local_table = ets:new(pg2_local_table, [ordered_set, protected, named_table]),
    {ok, #state{}}.
...
terminate(_Reason, _S) ->
    true = ets:delete(pg2_local_table),
    ok.
...
%%% One ETS table, pg2_local_table, is used for bookkeeping. The type of the
...
member_died(Ref) ->
    [{{ref, Ref}, Pid}] = ets:lookup(pg2_local_table, {ref, Ref}),
